...
//----------------------------------------------------------------------------
void senderInitSmall(int argc, char* argv[], H5FDdsmManager *dsmManager, MPI_Comm *comm,
    H5FDdsmInt32 *dataSizeMB)
{
  
  H5FDdsmInt32   rank, nlocalprocs;
  //
  // Sender does not use any special threads so MPI_Init is ok
  //
  MPI_Init(&argc, &argv);
...
//----------------------------------------------------------------------------
void senderInitIp2(int argc, char* argv[], int port, char* hostName, H5FDdsmManager *dsmManager, MPI_Comm *comm,
    H5FDdsmInt32 *dataSizeMB)
{
...
//----------------------------------------------------------------------------
void senderInitIp(int argc, char* argv[], int port, char* hostName, H5FDdsmManager *dsmManager, MPI_Comm *comm,
    H5FDdsmInt32 *dataSizeMB)
{
  H5FDdsmInt32   nlocalprocs, rank;
  H5FDdsmBoolean staticInterComm = H5FD_DSM_FALSE;
